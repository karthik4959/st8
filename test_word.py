...
def test_count_uppercase():
    ...
    expected_result = 1 # Expected out put
...
def test_count_lowercase():
    ...
    expected_result = 2 # expected out put
...
def test_count_vowels():
    text = "Hello, World" # Input for the test
    expected_result = 4 # expected out put for the test
...
def test_count_total_chars():
    text = "Hello, World" # input for the test
    expected_result = 1 # Expected output for the test
